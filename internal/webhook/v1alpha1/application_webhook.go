...
// +kubebuilder:webhook:path=/mutate-argoproj-argoproj-io-v1alpha1-application,mutating=true,failurePolicy=fail,sideEffects=None,groups=argoproj.argoproj.io,resources=applications,verbs=create;update,versions=v1alpha1,name=mapplication-v1alpha1.kb.io,admissionReviewVersions=v1
